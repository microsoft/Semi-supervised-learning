...
python train.py --c config/classic_cv/fixmatch/fixmatch_cifar10_250_0.yaml --use_post_hoc_calib True --n_cal 3000 --n_th 3000 --take_d_cal_th_from eval --loss_reweight False --aug_1 weak --aug_2 strong --gpu 0 --accumulate_pseudo_labels True --bayes False
