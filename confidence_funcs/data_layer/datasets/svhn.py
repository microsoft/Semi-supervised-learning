...
class SVHNData(Dataset):
    def __init__(self,data_conf):
        ...
        self.d = self.data_conf["dimension"] # should be 32x32
        self.num_classes = 10 
        self.f = None
    ...
    def build_dataset(self):
        ...
        self.data = torchvision.datasets.SVHN(root=self.data_conf['data_path'], 
                                              split='train', 
                                              download=True,
                                              transform=self.transform)
        
        self.test_data = torchvision.datasets.SVHN(root=self.data_conf['data_path'], 
                                                   split='test',
                                                   download=True,
                                                   transform=self.transform)
