...
class AimHook(Hook):
    ...
    def before_run(self, algorithm):
        ...
        data_setting = f"setting: {algorithm.args.dataset}_lb{algorithm.args.num_labels}_{algorithm.args.lb_imb_ratio}_ulb{algorithm.args.ulb_num_labels}_{algorithm.args.ulb_imb_ratio}"  # noqa: E501
