...
def get_cifar(
    args, alg, name, num_labels, num_classes, data_dir="./data", include_lb_to_ulb=True
):
    ...
    if name == "cifar10":
        ...
        raise ValueError(f"You need to set the n_v for dataset {name}")
    ...
    print(f"length of eval set: {len(eval_dset)}")
    print(f"length of test set: {len(test_dset)}")
